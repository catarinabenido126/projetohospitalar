                ...
                <div class="row">
                    <div class="col-md-3 mb-2">
                        <select name="modulo" class="form-select">
                            ...
                            <option value="Fornecedores"  <?= ($_GET['modulo'] ?? '') === 'Fornecedores'  ? 'selected' : '' ?>>Fornecedores</option>
                            <option value="Equipamentos"  <?= ($_GET['modulo'] ?? '') === 'Equipamentos'  ? 'selected' : '' ?>>Equipamentos</option>
                            <option value="Localizações"  <?= ($_GET['modulo'] ?? '') === 'Localizações'  ? 'selected' : '' ?>>Localizações</option>
                            <option value="Autenticação"  <?= ($_GET['modulo'] ?? '') === 'Autenticação'  ? 'selected' : '' ?>>Autenticação</option>
                        </select>
                    </div>
                    <div class="col-md-3 mb-2">
                        <select name="acao" class="form-select">
                            <option value="">Todas ações</option>
                            <option value="Criação"  <?= ($_GET['acao'] ?? '') === 'Criação'  ? 'selected' : '' ?>>Criação</option>
                            <option value="Edição"   <?= ($_GET['acao'] ?? '') === 'Edição'   ? 'selected' : '' ?>>Edição</option>
                            <option value="Remoção"  <?= ($_GET['acao'] ?? '') === 'Remoção'  ? 'selected' : '' ?>>Remoção</option>
                            <option value="Restauro" <?= ($_GET['acao'] ?? '') === 'Restauro' ? 'selected' : '' ?>>Restauro</option>
